...
class Frame extends MultiMain {
    ...
    initData() {
        let placeName = this.placeName = '白俄罗斯';
        this.pageTwo = [{
            title: '一 俄罗斯清关优势产品：',
            content: [
        ...
        this.pageFour = [
            [`<p>圣彼得堡</p><p>Санкт-Петербург</p>`, `<p>伏尔加格勒</p><p>Волгоград</p>`, `<p>托木斯克</p><p>Томск</p>`, `<p>雅库茨克</p><p>якутский</p>`],
            [`<p>切博克萨雷</p><p>Чебоксары</p>`, `<p>彼尔姆</p><p>Пермь</p>`, `<p>克拉斯诺亚尔斯克</p><p>Красноярск</p>`, `<p>乌法</p><p>Уфа</p>`],
            [`<p>喀山</p><p>Казань</p>`, `<p>鄂木斯克</p><p>Омск</p>`, `<p>下诺夫哥罗德</p><p>Нижний Новгород</p>`, `<p>叶卡捷琳堡</p><p>Екатеринбург</p>`],
            [`<p>新西伯利亚</p><p>Новосибирск</p>`, `<p>车里雅宾斯克</p><p>Челябинск</p>`, `<p>伊尔库茨克</p><p>Иркутск</p>`, `<p>乌兰乌德</p><p>Улан-Удэ</p>`],
            [`<p>海参崴</p><p>Владивосток</p>`, `<p>乌苏里</p><p>Уссурийск</p>`, `<p>哈巴罗夫斯克</p><p>Хабаровск</p>`]
        ];
        ...
        this.sliderData = {
            ...
            contentList: [{
                    pageOne: {
                        img: 1,
                        pageText: [
                            '亿宁国际货运代理有限公司（981Карго）是一家专注从事俄罗斯，白俄罗斯，乌克兰，白俄罗斯，哈萨克斯坦，立陶宛运输的品牌货代，公司总部在广州，公司经过多年的发展以在北京，义乌，都设立有分公司，我公司在俄罗斯境内成立了自已的清关团队，在运输方面我们做到了安全快捷，在清关方面我们做到了快速，各个环节精准控制，让客户无需担心清关的麻烦，我们一站式为你解决，随时随地都能掌握货物的运输状态。',
                    ...
                    pageTwo: [{
                        ...
                        title: `二 ${placeName}空运优势服务及时效：`,
                        content: [
                            '1、俄罗斯大货快空运：全程空运，时效5-8天到莫斯科，12天俄罗斯全境;',
                            '2、俄罗斯慢空运：全程空运，15天俄罗斯全境派送上门;'
                        ]
                    }],
                    ...
                    pageTwo: [{
                        ...
                        title: `二 ${placeName}陆运运优势服务及时效：`,
                        content: [
                            '1、俄罗斯专线普通陆运：18-25天到达莫斯科，30天以内覆盖俄罗斯全境；',
                            '2、俄罗斯专线超快陆运：12-16天到达莫斯科，22天以内覆盖俄罗斯全境'
                        ]
                    }],
                    pageThree: this.pageThree,
                    ...
                    pageTwo: [{
                        ...
                        title: `二 ${placeName}快递优势服务及时效：`,
                        content: [
                            '1、俄罗斯特快专递：客机带货，时效72小时以内到达莫斯科;',
                            '2、俄罗斯小件快递：全程空运，16天俄罗斯全境派送上门;',
                            '3、其它货物请咨询在线客服;'
                        ]
                    }],
                    pageThree: [
    ...
    initModel() {
        ...
        this.model = _.extend(this.model, {
            ...
            sliderContainer: sliderContainer.render({ sliderData: this.sliderData, placeName: this.placeName }).html
        });
